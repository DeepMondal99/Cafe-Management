...
txtReceipt = Text(ft2,font=('arial',11,'bold'),bd=8,width=27,height=22,bg="white")
...
btnTotal=Button(fb2,padx=16,pady=1,bd=4,fg="black",font=('arial',10,'bold'),width=2,text="Total",command=CostofItems).grid(row=0,column=0)

btnReceipt=Button(fb2,padx=16,pady=1,bd=4,fg="black",font=('arial',10,'bold'),width=2,text="Receipt",command=Receipt).grid(row=0,column=1)

btnReset=Button(fb2,padx=16,pady=1,bd=4,fg="black",font=('arial',10,'bold'),width=2,text="Reset",command=Reset).grid(row=0,column=2)

btnExit=Button(fb2,padx=16,pady=1,bd=4,fg="black",font=('arial',10,'bold'),width=2,text="Exit",command=qExit).grid(row=0,column=3)
